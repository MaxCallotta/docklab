...
@register_engine
class RDockEngine(BaseDockEngine):
    """rDock 对接适配器（预留）。"""

    engine_id = "rdock"
    engine_name = "rDock"
    description = "rDock 对接（预留模板）"
